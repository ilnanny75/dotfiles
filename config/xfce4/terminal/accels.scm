...
;
(gtk_accel_path "<Actions>/terminal-window/copy-html" "<Primary>c")
...
(gtk_accel_path "<Actions>/terminal-window/paste-selection" "<Primary>v")
...
(gtk_accel_path "<Actions>/terminal-window/open-folder" "<Super>t")
