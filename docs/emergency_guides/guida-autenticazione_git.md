...
- Verifica tracciamento branch: git branch -vv # Mostra quale piattaforma è configurata come predefinita (upstream)
- Info dettagliata remoti: git remote show github # Controlla lo stato di sincronizzazione e gli URL di push/fetch
- Switch upstream a GitHub: git push -u github main # Forza GitHub come memoria predefinita per i prossimi push
- Switch upstream a OpenCode: git push -u origin main # Forza OpenCode (origin) come memoria predefinita per i prossimi push
- Reset URL origin: git remote set-url origin https://github.com/USER/REPO.git # Cambia direttamente l'indirizzo fisico della memoria principale

## Esempio pratico :
Se al momento il terminale punta a OpenCode ma vuoi che con git push, i file vadano su GitHub,basta lanciare:
git push -u github main

Da quel momento in poi, la memoria è spostata.Verifica che il cambio sia avvenuto con :
git branch -vv.
---
